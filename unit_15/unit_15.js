...
const f2 = () => {
  let ad = +document.querySelector(".i-2").value;
  s2.add(ad);
  console.log(s2);
};
...
const f3 = () => {
  let del = document.querySelector(".i-3").value;
  s3.delete(del);
  console.log(s3);
};
...
const f7 = () => {
  let u = [];
  let pasw = document.querySelector(".i-7").value;
  let s7 = new Set(pasw);

  if (pasw.length > 6 && s7.size > 6) {
