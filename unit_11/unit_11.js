...
function f1() {
  let q = document.querySelector(".i-1").value;
...
function f6() {
  let u = document.querySelector(".i-6").value;
  d6[d6.length] = u;
  showArr(".out-6", d6);
}
...
function f8() {
  let u = document.querySelector(".i-8").value;
  let d8a = [];
  d8a[0] = u;
...
function f14() {
  d14 = [];
  let t = +document.querySelector(".i-14").value;
