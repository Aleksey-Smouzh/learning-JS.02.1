...
console.log('ДОБРО' + " ПШЖАЛОВАТЬ" + "НА КУРС ");
...
let out = document.querySelector('span.out-8');
out.innerHTML = "world";
...
let outt = document.querySelector('.out-10')
outt.innerHTML = '&#x3C;h2&#x3E;Hi&#x3C;/h2&#x3E;'
...
// На странице создан div.out-11. Запишите внутрь него строку '123'. Для записи используйте innerHTML. Второй операцией - допишите в div.out-11 строку '456'. Для дозаписи примените +=. Обратите внимание - код уже набран, вам нужно удалить комментарий и изучить принцип работы. 
 ...
 document.querySelector('.out-11').innerHTML += '678';
...
console.log(out19);
document.querySelector('.out-19-test').innerHTML = out19;
console.log(out19);
